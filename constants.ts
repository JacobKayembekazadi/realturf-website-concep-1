...
export const landscapeProducts: Product[] = [
  ...
  },
  {
    name: 'ECO C',
    category: 'landscape',
    description: 'Eco-friendly turf with excellent durability and natural appearance.',
...
export const sportsProducts: Product[] = [
  {
    ...
    faceWeightVal: 46,
    fiber: 'Textured',
    features: ['Professional Grade', 'True Roll', 'UV Protected', 'All-Weather', 'LongLife', 'MaxRecover'],
  ...
  },
  {
    ...
    features: ['FIFA Certified', 'Player Safety', 'Ball Interaction', 'Max Durability', 'LongLife', 'MaxRecover'],
